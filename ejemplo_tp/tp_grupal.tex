...
ContadorMayoresExtremoIzq(trayectoria) + \\
ContadorMayoresExtremoDer(trayectoria)) = 1))
...
\vspace{0.8cm}
\aux{ContadorMayoresExtremoIzq}{in trayectoria : {\TLista{\float}}}{\ent} {\\
{\IfThenElse{(trayectoria[0] > trayectoria[1]) \hspace{0.15cm} = \hspace{0.15cm} True}{1}{0}})}

\vspace{0.8cm}
\aux{ContadorMayoresExtremoDer}{in trayectoria : {\TLista{\float}}}{\ent} {\\
